        ...
        issueMatches.forEach((match) => {
          try {
            ...
            try {
              ...
              const curlCommand = `curl -s -m 5 -H "User-Agent: AntTheme-ReleaseNotes-Script" https://api.github.com/repos/BeardedBear/ant-theme/issues/${issueNumber}`;
            ...
            const issueLink = `[${match}${issueAuthor}](https://github.com/BeardedBear/ant-theme/issues/${issueNumber})`;
